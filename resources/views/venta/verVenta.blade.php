                                                    ...
                                                    <div class="tab-content" id="myTabContent">
                                                        <div class="tab-pane fade show active"
                                                            ...
                                                            <div style="overflow-x: auto;">
                                                                <!--begin::Table-->
                                                                <table class="table align-middle table-row-dashed fs-7 gy-6"
                                                                    id="kt_table_roles">
                                                                    <thead>
                                                                        <tr
                                                                    ...
                                                                    <tbody class="text-gray-600 fw-semibold">
                                                                        @forelse ($ordem_trabajos as $ordenTrabajo)
                                                                            <tr>
                                                                                ...
                                                                                <td>{{ $ordenTrabajo->focalizado?->nombre }}
                                                                                </td>
                                                                                <td>{{ $ordenTrabajo->tipoTela?->nombre }}</td>
                                                                                <td>{{ $ordenTrabajo->colorTela?->nombre }}</td>
                                                                                <td>{{ $ordenTrabajo->caracteristicaTela?->nombre }}
                                                                                </td>
                                                                                ...
                                                                                <td>
                                                                                    @if ($ordenTrabajo->estado == "RECEPCIONADO")
                                                                                        <span
                                                                                            class="badge badge-info">{{ $ordenTrabajo->estado }}</span>
                                                                                    @elseif($ordenTrabajo->estado == "TRABAJANDO" || $ordenTrabajo->estado == "EN PROCESO")
                                                                                        <span
                                                                                            class="badge badge-warning">{{ $ordenTrabajo->estado }}</span>
                                                                                    @elseif($ordenTrabajo->estado == "FINALIZADO")
                                                                                        <span
                                                                                            class="badge badge-success">{{ $ordenTrabajo->estado }}</span>
                                                                                    @elseif($ordenTrabajo->estado == "ENTREGADO")
                                                                                        <span
                                                                                            class="badge badge-dark">{{ $ordenTrabajo->estado }}</span>
                                                                                    @endif
                                                                                </td>
                                                                            </tr>
                                                                        @empty
                                                        ...
                                                        <div class="tab-pane fade" id="kt_tab_pane_8_pagos_{{ $keyPri }}"
                                                            role="tabpanel">
                                                            @php
                                        ...
                                        @foreach ($facturasInValidas as $key => $facturaInValida)
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <div id="kt_accordion_3_item_2_{{ $key }}"
                                                    ...
                                                    <div class="tab-content" id="myTabContent">
                                                        <div class="tab-pane fade show active"
                                                            id="kt_tab_pane_7_ots_2_{{ $key }}" role="tabpanel">
                                                            @php
