    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header" id="kt_modal_add_user_header">
                <h3 class="fw-bold">FORMULARIO DE MARCA <span class="text-info" id="nombre_busqueda"></span></h3>
            ...
            <div class="modal-footer">
                <div class="row">
                    <div class="col-md-12">
                        <button class="btn btn-sm w-100 btn-success" onclick="guardarMarca()">Guardar</button>
                    </div>
                </div>
            </div>
            <!--end::Modal body-->
        ...
        <div id="kt_app_content_container" class="app-container container-xxlg">
            <div class="card shadow-sm">
                <div class="card-header bg-light-info py-4 d-flex align-items-center justify-content-between">
                    <h3 class="card-title fw-bold">Listado de Marcas</h3>
                    <div class="card-toolbar">
                        <button type="button" class="btn btn-primary btn-sm" onclick="modalNuevoMarca()">
                    ...
                    $.ajax({
                        ...
                        success: function (resultado) {
                            if (resultado.estado) {
                                ...
                                Swal.fire(
                                    'Error',
                                    resultado.message || 'No se pudo eliminar la marca.',
                                    'error'
                                );
                            }
                        },
