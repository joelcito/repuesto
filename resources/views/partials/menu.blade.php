                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ Route::currentRouteName() == 'unidad.listado' ? 'active' : '' }}"
                                ...
                                <span class="menu-title text-white">Unidades</span>
                            </a>
                        </div>
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ Route::currentRouteName() == 'marca.listado' ? 'active' : '' }}"
                                ...
                                <span class="menu-title text-white">Marcas</span>
                            </a>
                        </div>
                        <div class="menu-item">
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ Route::currentRouteName() == 'devolucion.listado' ? 'active' : '' }}"
                                ...
                                <span class="menu-title text-white">Devolucion</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link {{ Route::currentRouteName() == 'incorporacion.listado' ? 'active' : '' }}"
                                ...
                                <span class="menu-title text-white">Incorporacion</span>
                            </a>
                        </div>
